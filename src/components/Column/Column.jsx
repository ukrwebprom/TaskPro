...
export const Column = ({ allColumns, data }) => {
      ...
      <section className={css.containerColumn}>
        <div className={css.wrapperTitleColumn}>
          ...
          <div className={css.wrapperButton}>
            <button
              className={`${css.buttonColumn} ${css.editIcon}`}
              type="button"
              onClick={() =>
                getModal(
                  'Edit column',
            ...
            <button
              className={`${css.buttonColumn} ${css.deleteIcon}`}
        ...
        <Button
          ...
          type="button"
          action={() =>
            getModal('Add card', <CardForm setTask={handleAddTask} />)
          }
        />
      </section>
    </>
